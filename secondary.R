...
# Summary tables
tabulate_num_pupils_summary(secondaries_tidy, save_to_file=TRUE)
tabulate_support_category_summary(secondaries_tidy, save_to_file=TRUE)
...
# Support category
# All of Wales
map_support_categories(secondaries_tidy_geo, save_to_file=TRUE)
# A single LA
map_support_categories(secondaries_tidy_geo %>% filter(local_authority == 'Powys'), 'Powys', save_to_file=TRUE)
# Per LA controls
map_support_categories_by_local_authority(secondaries_tidy_geo, save_to_file=TRUE)

# Outturn - surplus or deficit
# All of Wales - probably don't want this
map_outturn_surplus_or_deficit_by_year(secondaries_tidy_geo_all_years, save_to_file=TRUE)
# A single LA
map_outturn_surplus_or_deficit_by_year(secondaries_tidy_geo_all_years %>% filter(local_authority == 'Powys'), 'Powys', save_to_file=TRUE)
