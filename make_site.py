...
<tr>
""")
        for type in ('_primary_pupil_funding_vs_fsm.png', '_primary_pupil_funding_vs_outturn.png', '_primary_pupil_funding_vs_pupil_outturn.png', '_primary_pupil_funding_vs_year.png', '_primary_school_funding_vs_size.png'):
